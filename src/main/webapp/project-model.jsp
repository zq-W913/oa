        ...
        function loadData(pageNum,pageSize) {
            $.ajax({
                ...
                success : function (data) {
                    var tr = "";
                    $(data.list).each(function (index,mod) {
                        tr += "<tr class='newtr' align='center' bgcolor=\"#FFFFFF\" onMouseMove=\"javascript:this.bgColor='#FCFDEE';\" onMouseOut=\"javascript:this.bgColor='#FFFFFF';\" height=\"22\" >\n" +
                            ...
                            "\t<td>"+mod.id+"</td>\n" +
                            "\t<td align=\"center\"><a href=''><u>"+mod.modname+"</u></a></td>\n" +
                            "\t<td align=\"center\"><a href=''><u>"+mod.analysis.title+"</u></a></td>\n" +
                            "\t<td align=\"center\"><a href=''><u>"+mod.project.pname+"</u></a></td>\n" +
                            "\t<td>"+mod.level+"</td>\n" +
                            "\t<td>"+mod.simpledis+"</td>\n" +
                            "\t<td><a href=\"project-model-edit.jsp?mid="+mod.id+"\">编辑</a> | <a href=\"project-model-look.jsp\">查看详情</a></td>\n" +
                            "</tr>";
                    })
                    $(".newtr").remove();
                    $("#trr").after(tr);
